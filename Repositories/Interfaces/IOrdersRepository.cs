...
namespace WMS_Application.Repositories.Interfaces
{
    public interface IOrdersRepository
    {
        ...
        List<ProductS2SBuyDto> GetProductsC2S(string? productName, int? category, int? company);
        List<ProductS2SBuyDto> GetProductsS2SBuy(string? productName, int? category, int? shop, int userId);
